...
CREATE TABLE `tblmedicos` (
  ...
  KEY `tipodoc` (`tipodoc`),
  CONSTRAINT `tblmedicos_ibfk_1` FOREIGN KEY (`tipodoc`) REFERENCES `tbltipodocumento` (`idtipodocumento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tblpacientes` (
  ...
  KEY `genero` (`genero`),
  CONSTRAINT `tblpacientes_ibfk_1` FOREIGN KEY (`tipodocumento`) REFERENCES `tbltipodocumento` (`idtipodocumento`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tbltipodocumento` VALUES (1,'Cedula Ciudadania'),(2,'Registro Civil'),(3,'Tarjeta de Identidad');
...
-- Dump completed on 2020-03-01 18:21:52
